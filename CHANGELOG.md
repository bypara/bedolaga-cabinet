...
## [1.72.0](https://github.com/bypara/bedolaga-cabinet/compare/v1.71.1...v1.72.0) (2026-09-11)


### Features

* add admin legal pages api client and display mode types ([e979aa8](https://github.com/bypara/bedolaga-cabinet/commit/e979aa8863e32cd141722dbc1690fac12bfedeae))
* add display mode selector to info page editor ([04cbbb5](https://github.com/bypara/bedolaga-cabinet/commit/04cbbb5e5182ee3996d62356917c7786132ea8ac))
* add mandatory legal onboarding ([59b6853](https://github.com/bypara/bedolaga-cabinet/commit/59b6853e1b0cb2396c31127812db087879258d0f))
* add sort by subscription expiry to user list ([89a9f9f](https://github.com/bypara/bedolaga-cabinet/commit/89a9f9f70c5910916097818696711cb99ae19bcc))
* add system pages admin section ([0d6a85a](https://github.com/bypara/bedolaga-cabinet/commit/0d6a85a4f91ec07b1f87207e1502e30fbf3aeb2c))
* **admin-tickets:** deep-link to a specific ticket from notifications ([ff0b119](https://github.com/bypara/bedolaga-cabinet/commit/ff0b119ebc02ecf053f568d53fc77363a31f1338))
* **admin:** explain where day rewards land when no tariff is set ([d5e3b02](https://github.com/bypara/bedolaga-cabinet/commit/d5e3b022f04ec87edb2ae839f5b4a30cc03c7403))
* **admin:** import legacy referral settings from the cabinet ([c3c7994](https://github.com/bypara/bedolaga-cabinet/commit/c3c799449a09469a500a7d456a0675f2e0f46009))
* **admin:** overpay certificate upload block ([f523604](https://github.com/bypara/bedolaga-cabinet/commit/f52360449b5888026e45b8cecf34d2a10ebb0dad))
* **admin:** quick amounts editor in payment method settings ([bb8b823](https://github.com/bypara/bedolaga-cabinet/commit/bb8b823b3778ac31538cb980c7323f7ca33d212a))
* **admin:** reward level editor in the cabinet ([99eacfa](https://github.com/bypara/bedolaga-cabinet/commit/99eacfa1602d340476967a2942d1026a68c32acd))
* **admin:** set how many referrals unlock a reward level ([8f6181f](https://github.com/bypara/bedolaga-cabinet/commit/8f6181f5dcd74976b60584fb0684ed533e05a87d))
* **admin:** set the referral chain depth from the level editor ([caf21ec](https://github.com/bypara/bedolaga-cabinet/commit/caf21ec313abb9e84a6d26dd560cd33399b98c3e))
* **admin:** show common placeholders group in email template editor ([8b2501d](https://github.com/bypara/bedolaga-cabinet/commit/8b2501d908b17a4f5402571da778e0cb793cc934))
* **admin:** surface what the legacy import could not carry over ([b65137e](https://github.com/bypara/bedolaga-cabinet/commit/b65137ee086ffcd3347a54066ffaeaff9991fb18))
* **admin:** бейдж «Команда» для команд бота в таймлайне активности ([f9ee16a](https://github.com/bypara/bedolaga-cabinet/commit/f9ee16a2e67ed36b8672dd35b4a27d075743cc0a))
* **admin:** вкладка «Активность» в карточке пользователя ([7547b49](https://github.com/bypara/bedolaga-cabinet/commit/7547b49d7a58745487693040537ddfb1bfa9dd43))
* **admin:** клики кнопок бота и действия в кабинете во вкладке «Активность» ([5fc8e7f](https://github.com/bypara/bedolaga-cabinet/commit/5fc8e7f97a2f09f4d81ff17fa3914eacc7db58b7))
* **admin:** кнопка повторной доставки ошибки ([7c63bcd](https://github.com/bypara/bedolaga-cabinet/commit/7c63bcd474dbbe95a8455c839dac418435f2a615))
* **admin:** очередь писем видна в разделе шаблонов — состояние и очистка ([15e02d4](https://github.com/bypara/bedolaga-cabinet/commit/15e02d4b9a7204f18c7403490ec14b10ee2ba300))
* **admin:** панельная идентичность под Remnawave 3.0.0 ([e840ed2](https://github.com/bypara/bedolaga-cabinet/commit/e840ed2b60f5e525cb290ce5bddc70ef6dfe8a66))
* **admin:** переключатель «отправлять это письмо» в редакторе email-шаблонов ([745e839](https://github.com/bypara/bedolaga-cabinet/commit/745e8397916754a9fb6d654e08f60afd15e9d14e))
* **admin:** пометка «Задано в .env» в настройках партнёрки и тикетов ([d6ec246](https://github.com/bypara/bedolaga-cabinet/commit/d6ec24685d214159bdae165e5553ee80eb41f106))
* **admin:** превью письма рассылки рендерит бот — в общей обёртке ([f18d64c](https://github.com/bypara/bedolaga-cabinet/commit/f18d64c3dd1d5ebab64d0c976cd0940e860b9269))
* **admin:** предупреждать, когда весь раздел закреплён в .env ([2f95c6a](https://github.com/bypara/bedolaga-cabinet/commit/2f95c6a6742f6293bdec9e74eb22fb8f0fabdee3))
* **admin:** предупреждение о разбивке длинных текстов системных страниц в боте ([93cfca4](https://github.com/bypara/bedolaga-cabinet/commit/93cfca46dc133662329aa0ec8196f91f15ba4b3a))
* **admin:** раздел grace-доступа в админменю ([bd86d3d](https://github.com/bypara/bedolaga-cabinet/commit/bd86d3d27ca8bf9d71912a9a1d4392439704c208))
* **admin:** редактор email-шаблонов понимает общую обёртку писем ([3f07301](https://github.com/bypara/bedolaga-cabinet/commit/3f0730191d0d0ff04fd7353d848c4fc8eb760142))
* **admin:** скелетоны вместо спиннеров в админке ([a330036](https://github.com/bypara/bedolaga-cabinet/commit/a330036ebe7fa06d96ea7b99441f8054fa2793ee))
* **admin:** статус и отмена СБП-автопродления в карточке юзера ([3328493](https://github.com/bypara/bedolaga-cabinet/commit/332849393c00fa4f7e143af2b293a2775c0a4e8e))
* **admin:** страница системных ошибок ([a337b96](https://github.com/bypara/bedolaga-cabinet/commit/a337b96f9b76d2350c21e280fbd33548d5fec5c1))
* **admin:** страница системных ошибок ([d2e25ab](https://github.com/bypara/bedolaga-cabinet/commit/d2e25abe94f72a0a76ce413c5c7db0b4959dcef6))
* **auth:** allow manual opt-in for deep-link Telegram login ([d03b9bd](https://github.com/bypara/bedolaga-cabinet/commit/d03b9bdad785ac7710f30527f230eeb793e1089b))
* **auth:** чекбоксы согласия с офертой и политикой при первой авторизации ([0f21629](https://github.com/bypara/bedolaga-cabinet/commit/0f21629ba516118790c5d7f65df18f485dfaeafe))
* **auth:** экран «Проверьте почту» перестал быть тупиком ([b1d03ec](https://github.com/bypara/bedolaga-cabinet/commit/b1d03ec60667709b4ffc92847f30369f30cdcbf1))
* auto-save payment method order ([46335d2](https://github.com/bypara/bedolaga-cabinet/commit/46335d2375a576c2ee1330fa024f97634dac14d4))
* **backgrounds:** add constellation background ([510e4bd](https://github.com/bypara/bedolaga-cabinet/commit/510e4bd7383af7ac595f31cbe11eebbde5073792))
* **backgrounds:** add fireflies background ([1d00ca9](https://github.com/bypara/bedolaga-cabinet/commit/1d00ca97e52db514083ca0a06ac54d33637b6625))
* **backgrounds:** add liquid-gradient background ([71160c6](https://github.com/bypara/bedolaga-cabinet/commit/71160c670019ab7a5adaedf2beae4ea1e937d7cc))
* **backgrounds:** add matrix-rain background ([ab91c86](https://github.com/bypara/bedolaga-cabinet/commit/ab91c86f81afa2166700ccc7dd9bde70a8d5ce7b))
* **backgrounds:** add snowfall background ([e3dbc4e](https://github.com/bypara/bedolaga-cabinet/commit/e3dbc4e663419db99d391b43f2262af392a7528c))
* **backgrounds:** add starfield background with depth projection ([3742f2f](https://github.com/bypara/bedolaga-cabinet/commit/3742f2f88df4d141ff344affed6844d6cea75815))
* **balance:** per-method quick amounts on top-up page ([25784db](https://github.com/bypara/bedolaga-cabinet/commit/25784dbe181a515a3c340f086fda347f77b86031))
* **balance:** СБП-привязки в сохранённых методах ([d938ac2](https://github.com/bypara/bedolaga-cabinet/commit/d938ac2dd9d9f9e27142ed578e17cc7d76ca4531))
* **branding:** загрузка видео стартового меню бота ([c9afea7](https://github.com/bypara/bedolaga-cabinet/commit/c9afea7a5043e2a3b02d2242a116878fc70a0be6))
* **broadcasts:** поле icon_custom_emoji_id для кастомных кнопок рассылки ([b4b4bca](https://github.com/bypara/bedolaga-cabinet/commit/b4b4bca2cb290c1be4ae4c076593200c686b72c5))
* **broadcasts:** поле icon_custom_emoji_id у кастомных кнопок рассылки ([eeb715c](https://github.com/bypara/bedolaga-cabinet/commit/eeb715c09535a4e1d2489cd2c9d5969346718a26))
* **cabinet:** bulletproof Close button + kill the /login flash on the service-unavailable screen ([7413837](https://github.com/bypara/bedolaga-cabinet/commit/7413837fafdf7346054b72bbd05a1c42c4e38bd2))
* **cabinet:** legal footer on login + admin toggle ([984d1b0](https://github.com/bypara/bedolaga-cabinet/commit/984d1b077616a352eb972daa02a9030545afc55e))
* **cabinet:** premium redesign of all 5 full-screen blocking states ([782568e](https://github.com/bypara/bedolaga-cabinet/commit/782568e091fbe636c9f3136002f5b230089cdc04))
* **cabinet:** recoverable "service unavailable" screen when the backend is unreachable ([ac8a0fc](https://github.com/bypara/bedolaga-cabinet/commit/ac8a0fc41aff4065fdf1dde0bbc47694bfd1f010))
* **connected-accounts:** email-merge confirmation via emailed one-time code ([3224320](https://github.com/bypara/bedolaga-cabinet/commit/322432009502e6b983f286747e1d4840123fb7db))
* **coupons:** лимит на пользователя и удаление партии в кабинете ([390da33](https://github.com/bypara/bedolaga-cabinet/commit/390da33914eb3f992719e33acf85decac660a880))
* **coupons:** раздел оптовых купонов + публичная страница активации ([799e986](https://github.com/bypara/bedolaga-cabinet/commit/799e986d841aadf8a02ccc8287320a025e6a0aac))
* **dashboard:** плитка «Подключить устройство» на главной ([06c7d13](https://github.com/bypara/bedolaga-cabinet/commit/06c7d1388308de5fc1adad0cd2697d3c03c41c49))
* **dashboard:** подключение устройства прикреплено к карточке подписки ([28e25a9](https://github.com/bypara/bedolaga-cabinet/commit/28e25a92922501ed609623776e987fcd96f71032))
* **desktop-header:** group nav into a centered segmented capsule ([7de9b3b](https://github.com/bypara/bedolaga-cabinet/commit/7de9b3b51be095da15a9035c98d0aefa4b526838))
* filter admin users by tariff ([b927055](https://github.com/bypara/bedolaga-cabinet/commit/b9270550da14a96085dbec167bcfa38623eb4c8a))
* **gift:** QR подарка и сканирование в кабинете ([0e4dc43](https://github.com/bypara/bedolaga-cabinet/commit/0e4dc43335135fe229ce3c695fd7fa2722eb87e4))
* **gift:** transferable gift claim — buyer share link + recipient claim page ([db31d39](https://github.com/bypara/bedolaga-cabinet/commit/db31d395cd70055da8b0cbf697fc70173b45401a))
* hide info tabs by display mode visibility ([39758a1](https://github.com/bypara/bedolaga-cabinet/commit/39758a18b04c7af2bb0d629cda69e1b978196672))
* **landing-stats:** rebuild charts on shared components + add funnel & breakdowns ([78c633f](https://github.com/bypara/bedolaga-cabinet/commit/78c633ff548e893978f3bb7213475501a5562d56))
* **landing:** автозаполнение поля контакта из параметра URL (?contact=...) ([8d0c33b](https://github.com/bypara/bedolaga-cabinet/commit/8d0c33bb08b8f28b19367d1ea612a8455fba0ff1))
* **landing:** отправлять слаг рекламной кампании при гостевой покупке ([cfc2ab2](https://github.com/bypara/bedolaga-cabinet/commit/cfc2ab2f7fe641570a818d0ca75c9cd9dddbf2b7))
* **landing:** отправлять слаг рекламной кампании при гостевой покупке ([d4379fc](https://github.com/bypara/bedolaga-cabinet/commit/d4379fce25af69e866e9232a3cd036652e7eae17))
* **landing:** фолбэк на глобальную тему кабинета, когда у лендинга своя не задана ([0859583](https://github.com/bypara/bedolaga-cabinet/commit/085958342e023ecf5811208644a1db54029ab67b))
* **lava:** автопродление Lava на странице подписки ([2dce539](https://github.com/bypara/bedolaga-cabinet/commit/2dce539da2a7c3128084ed2bc6bcdf560d440c75))
* **lava:** покупка привязкой, продукт тарифа в админке, CTA ([a28f116](https://github.com/bypara/bedolaga-cabinet/commit/a28f1167f7af57bfc6e5c7c370849e7478ec459f))
* **legal:** wire recurrent-payments document + restore footer link ([20565b8](https://github.com/bypara/bedolaga-cabinet/commit/20565b8f593f99533a016ae4706fc1030a8a8d57))
* manage tariff subscribers in cabinet ([9f0f0e1](https://github.com/bypara/bedolaga-cabinet/commit/9f0f0e15fc89964e10a962dec46c0b1413a333c8))
* **navigation:** startapp=trial → дашборд (оплата платного триала из rich-меню) ([c920330](https://github.com/bypara/bedolaga-cabinet/commit/c920330fa606350c40c3ecaeb83651d5100b3f15))
* **navigation:** роутинг startapp-диплинков rich-меню бота ([2eaea75](https://github.com/bypara/bedolaga-cabinet/commit/2eaea75fd93f1db3a0203ff308f365b11079cbc4))
* **payments:** ParityPay в кабинете ([04dd888](https://github.com/bypara/bedolaga-cabinet/commit/04dd8882ed0a971e3c68d7262e409cbb3ef3f5b9))
* **payments:** TabPay в кабинете ([47f8760](https://github.com/bypara/bedolaga-cabinet/commit/47f8760d8816eafa6b58b13290e313ae4eb73fb3))
* **payments:** способ оплаты cisPay ([4b98217](https://github.com/bypara/bedolaga-cabinet/commit/4b982175d75f5d7d43312859cc061462b52f9570))
* per-method quick amounts, system pages admin, animated backgrounds overhaul ([47119c4](https://github.com/bypara/bedolaga-cabinet/commit/47119c4c1fcb134a05845a71b29b6ec04648067e))
* **profile:** consolidate account navigation ([8232c16](https://github.com/bypara/bedolaga-cabinet/commit/8232c16e223e2bc2dff9110764ff26446bcb60df))
* **profile:** improve account and header controls ([cbf4000](https://github.com/bypara/bedolaga-cabinet/commit/cbf40005ae8450d08c43c80560f7fc8e92734129))
* **promo-offers:** охват сегментов и прогресс доставки на странице отправки ([c6d8c0a](https://github.com/bypara/bedolaga-cabinet/commit/c6d8c0afe0a30b864a9d0834735fdc7b52d8f362))
* **promocodes:** состав промокода чекбоксами — баланс / дни / промогруппа ([9ce838b](https://github.com/bypara/bedolaga-cabinet/commit/9ce838badeda4dde45b16f38458e260a100fb39d))
* **promocodes:** трафик в наборе бонусов промокода ([f6a64bf](https://github.com/bypara/bedolaga-cabinet/commit/f6a64bfc1eb885cde31bcbab1f1474b1d693e718))
* **reachability:** «Что проверить?» — объём с ценой и временем, запуск пачки ([c056216](https://github.com/bypara/bedolaga-cabinet/commit/c056216842bd73b7ae9d45947103a79c99e8dfff))
* **reachability:** BSCHEKER одной страницей как bsbord.com — вкладки, операторы по округам, «Запуск» рядом ([149635d](https://github.com/bypara/bedolaga-cabinet/commit/149635dcdb043cd92470ed1d7073c4c91a3c454b))
* **reachability:** выбор симок и панель запуска с ценой ([f67d51f](https://github.com/bypara/bedolaga-cabinet/commit/f67d51f0184d6d455448a46d3c87c9da58b2a2cc))
* **reachability:** выбор целей и вкладки запуска probe / VLESS / скан ([9d770e4](https://github.com/bypara/bedolaga-cabinet/commit/9d770e4f8eb69169cd9d21da2ec679a62124b206))
* **reachability:** иконка оператора svyaz1 («Связь сразу») ([9ffd8a6](https://github.com/bypara/bedolaga-cabinet/commit/9ffd8a62cff48cc4abe2209cc554e7f6ce8d9eb2))
* **reachability:** иконки операторов в группах симок, чипах и шапках таблиц ([1146559](https://github.com/bypara/bedolaga-cabinet/commit/1146559e0cbacea8e63e7caba36bd90d3c5002c9))
* **reachability:** история проверок — вкладка со значком, пачка одной строкой, фильтр по серверу ([cabfd84](https://github.com/bypara/bedolaga-cabinet/commit/cabfd8450d1b7b5573d4d6e25852c552a2464f05))
* **reachability:** карточка настройки BSCHEKER вместо голого предупреждения ([a1a2952](https://github.com/bypara/bedolaga-cabinet/commit/a1a2952d778a4590de7d6a5e4fbead1b3d406cb4))
* **reachability:** карточка сервера — по операторам словами, история, проверка одного сервера ([ba8b1a2](https://github.com/bypara/bedolaga-cabinet/commit/ba8b1a22ebd772085e057661c9da56ffc1687343))
* **reachability:** карточка сервера раскрывается под строкой — в разделе не осталось модалок и шитов ([a89d760](https://github.com/bypara/bedolaga-cabinet/commit/a89d7608bf103fdb75055734f9a5acbb96532b8b))
* **reachability:** локали раздела как состояния флота ([e4f74a3](https://github.com/bypara/bedolaga-cabinet/commit/e4f74a3e3670d1d294f0449b454a4e55cca52a95))
* **reachability:** модуль API раздела и форматирование копеек ([3cb9b0a](https://github.com/bypara/bedolaga-cabinet/commit/3cb9b0aca8924d63b956f2dfe8d2fbb970d9ae3d))
* **reachability:** переделка по ревью — явный выбор и подтверждение списания, общие компоненты, мобильная вёрстка ([fc5090a](https://github.com/bypara/bedolaga-cabinet/commit/fc5090acd6041d87261dfc7cae0cd57995f6aa26))
* **reachability:** пересборка BSCHEKER — один поток запуска, операторы по округам, «Запуск» под рукой ([77d92ca](https://github.com/bypara/bedolaga-cabinet/commit/77d92ca025ac3e173a9ddb21b7760ad63da234f3))
* **reachability:** подтверждение запуска в браузере — второй шаг в панели вместо системного окна ([69a80a4](https://github.com/bypara/bedolaga-cabinet/commit/69a80a4ee5f15159a8a220e6dab47a7ffb6187b4))
* **reachability:** прогресс задачи с опросом и результаты probe / VLESS / скана ([413d531](https://github.com/bypara/bedolaga-cabinet/commit/413d531870e6319f53b26680b3648c66639474b8))
* **reachability:** прогресс пачки по целям из частичных результатов ([bd68ef0](https://github.com/bypara/bedolaga-cabinet/commit/bd68ef0dfe4a38d16b413ee32b39d93e45b3af24))
* **reachability:** раздел «Доступность из РФ» — маршрут, меню, статус, локали ([1ccce54](https://github.com/bypara/bedolaga-cabinet/commit/1ccce544392ed0fc9920231700bb742e0e77000f))
* **reachability:** раздел как состояние флота — страница, карточка, запуск, прогресс, история и одиночные проверки отдельными экранами ([8c121a8](https://github.com/bypara/bedolaga-cabinet/commit/8c121a850ff89ddffa7104c569a5d1b4af4a4a4f))
* **reachability:** сводка флота одним предложением ([022f168](https://github.com/bypara/bedolaga-cabinet/commit/022f1681c29be737ba30350ac03ea0af7277c52d))
* **reachability:** сводка хост × симка и история задач ([3d58387](https://github.com/bypara/bedolaga-cabinet/commit/3d583876c623b5e8e6a98184a6e835d5ecd18d6d))
* **reachability:** серверы одной таблицей, карточка без дублей, история внизу страницы ([e8ee7cf](https://github.com/bypara/bedolaga-cabinet/commit/e8ee7cf126759d25f633307c86ddf56f38a0b938))
* **reachability:** симки, пробы и SNI на виду, быстрая проверка адреса или подписки первым блоком ([cbb0171](https://github.com/bypara/bedolaga-cabinet/commit/cbb01710ca3f658846a6df7a17d7f27e6d17907a))
* **reachability:** состояние флота — чистые функции ([85bb407](https://github.com/bypara/bedolaga-cabinet/commit/85bb407d216f0de7bd1cae3b787218f10afc03f6))
* **reachability:** список серверов группами, проблемы сначала ([8b2fbeb](https://github.com/bypara/bedolaga-cabinet/commit/8b2fbeb4c2b159bc1c3b2d354c15fd37918b32a4))
* **reachability:** суммы в кредитах BSCHEKER, рубли справочно ([573601b](https://github.com/bypara/bedolaga-cabinet/commit/573601bb79aa95ad492e245796031a7aa980fa1d))
* **reachability:** типы и клиент пачек проверок, частичного результата, active_batch ([8d8ec35](https://github.com/bypara/bedolaga-cabinet/commit/8d8ec359a777803e8645908be89997420d543aac))
* **reachability:** фильтры и поиск по серверам ([d13969a](https://github.com/bypara/bedolaga-cabinet/commit/d13969a9a1491a56bc7c967eaa9dad0d7a71839e))
* **reachability:** хуки состояния флота и опроса пачки ([13d4921](https://github.com/bypara/bedolaga-cabinet/commit/13d4921f84fee8cb3f55b53283981a647605df48))
* **reachability:** экран идущей проверки — прогресс, остановка, список по серверам ([2da479b](https://github.com/bypara/bedolaga-cabinet/commit/2da479b51950317265b23475bfee8039e912e86c))
* **reachability:** ярлыки проверки на карточке ноды и у подписки пользователя ([12531f9](https://github.com/bypara/bedolaga-cabinet/commit/12531f90580c68353e417d57a0de41ef89ff5b21))
* **reachability:** ярлыки, цвета вердиктов и выбор симок — чистые модули ([cc0b412](https://github.com/bypara/bedolaga-cabinet/commit/cc0b4123c51c642bbb8280328a5ebfa3323b8547))
* redesign cabinet experience ([3e0a5cd](https://github.com/bypara/bedolaga-cabinet/commit/3e0a5cdb08ac0c208caf92cb9760ecf1b8369a99))
* **referral-network:** кнопка построения полной реферальной сети ([19facf2](https://github.com/bypara/bedolaga-cabinet/commit/19facf2ba968212ba9f1bb974ce886e9facc348f))
* **referral:** render day rewards and chain levels ([1003bfc](https://github.com/bypara/bedolaga-cabinet/commit/1003bfc53903fc6337156c2aedd703d93a1f7461))
* **referral:** блокировать поле глубины, закреплённое в .env ([b35b19b](https://github.com/bypara/bedolaga-cabinet/commit/b35b19bc587575134c7fee39fb2b62f128ef1efb))
* **referral:** выбор награды карточками с иконками, деньги или дни ([4db4fd1](https://github.com/bypara/bedolaga-cabinet/commit/4db4fd1f2b072e2e86c18bcf21abe4473ca71bb0))
* **referral:** карточка настроек наград на экране партнёра ([7d51713](https://github.com/bypara/bedolaga-cabinet/commit/7d51713cb8470f561e85abf8f4b07d701547956d))
* **referral:** понятная карточка условий и «Ваш уровень» вместо глубины сети ([20ad959](https://github.com/bypara/bedolaga-cabinet/commit/20ad9598a0d30ca8881ea524b2db586393246b1d))
* **referral:** предупреждать о выключенном мультитарифе в редакторе уровней ([097cd1e](https://github.com/bypara/bedolaga-cabinet/commit/097cd1e52735d82aafd82cf11be9008acacf4db7))
* **referral:** режим рангов в редакторе уровней и на экране партнёра ([28cb8dc](https://github.com/bypara/bedolaga-cabinet/commit/28cb8dc4a35555d4622bb3337e58bc79b9b52101))
* **referral:** суммы на карточках выбора и подписка только под дни ([e31c76c](https://github.com/bypara/bedolaga-cabinet/commit/e31c76c6d71c67799bb15d704bb268fca717382b))
* **remnawave:** GeoCheck ноды в админке — запуск проверки и просмотр отчёта ([b4e1de6](https://github.com/bypara/bedolaga-cabinet/commit/b4e1de6152cfc85418c62e4f840180411989a2a7))
* **sales-stats:** вкладка «Оплаты» — success-rate и неудачные покупки ([436d9f8](https://github.com/bypara/bedolaga-cabinet/commit/436d9f860c89a4012c57a9689b11abdff1572332))
* **sales-stats:** душевные карточки с иконками + фикс скачка при смене периода ([dfc7768](https://github.com/bypara/bedolaga-cabinet/commit/dfc7768a403c9d8ff91a79cea8df9207b1855d8c))
* **sales-stats:** иконки на карточках во всех вкладках ([80ac631](https://github.com/bypara/bedolaga-cabinet/commit/80ac63102b91a3aced5b3b599c5da05b6803bffa))
* **sales-stats:** карточки возвратов в сводке ([bd12113](https://github.com/bypara/bedolaga-cabinet/commit/bd12113294c92379fc7fee6d4c25f1d73e3de856))
* **sales-stats:** конкретика в сводке ([3adda6f](https://github.com/bypara/bedolaga-cabinet/commit/3adda6fa032e3d105b8b7836b478f68f4c5e6d9f))
* **sales-stats:** пресет «Этот месяц» (с 1-го числа) и он же по умолчанию ([9a05f23](https://github.com/bypara/bedolaga-cabinet/commit/9a05f23a04358affca5faa0acb5cd81911372136))
* **sbp-recurring:** СБП-оформление подписки на форме покупки тарифа ([f448c14](https://github.com/bypara/bedolaga-cabinet/commit/f448c149946cefee83e0e61f9c3c03b0d69a4362))
* **subscription:** API и утилиты СБП-автопродления Platega ([9093aec](https://github.com/bypara/bedolaga-cabinet/commit/9093aec207bbc41e07433d55a90f9464c33a4b39))
* **subscription:** streamline management and promo activation ([7a01e3c](https://github.com/bypara/bedolaga-cabinet/commit/7a01e3ca36dceafcc1d60785710a1a44c5e05daa))
* **subscription:** блок СБП-автопродления на странице подписки ([29a3683](https://github.com/bypara/bedolaga-cabinet/commit/29a36837c8ad1310cce8fafa3e28f041c69a8d37))
* **tariffs:** выгодный период обведён рамкой при покупке и продлении ([bb239a4](https://github.com/bypara/bedolaga-cabinet/commit/bb239a42c85383099455b18ee8c40157d4722e7a))
* **tariffs:** выделенный тариф обведён рамкой в списке покупки ([81bb73d](https://github.com/bypara/bedolaga-cabinet/commit/81bb73dc156006ee9abf95e5c8f3c8bdfff7bf69))
* **ui:** reorganize profile and mobile navigation ([c9bf8f9](https://github.com/bypara/bedolaga-cabinet/commit/c9bf8f92c9cfbf2d8936da8a1bb3559c37344d1b))
* **ui:** streamline profile and subscription states ([432e31a](https://github.com/bypara/bedolaga-cabinet/commit/432e31a84cb36eec688ebfb9e52f2b5ebc3268cb))
* **ui:** доперевести пользовательские экраны со спиннеров на скелетоны ([7b9c78c](https://github.com/bypara/bedolaga-cabinet/commit/7b9c78c14ea4ca318be35eba3983e49d3bc9cd83))
* **ui:** единый источник правды по стилям скелетонов ([f1ce830](https://github.com/bypara/bedolaga-cabinet/commit/f1ce830266ae6ae551edfee19d17df7c3bc87bc5))
* **ui:** заменить все нативные date-инпуты на DateField ([016da9f](https://github.com/bypara/bedolaga-cabinet/commit/016da9f638ca4a7ecec35e0d77c0e851bc3b8808))
* **ui:** клавиша «Готово» на экранной клавиатуре для всех однострочных полей ([525a6f3](https://github.com/bypara/bedolaga-cabinet/commit/525a6f38c1a7a6b2d9b247cfa70609bb57c50aeb))
* **ui:** примитив Skeleton и SkeletonGroup вместо двух мёртвых компонентов ([b6b608e](https://github.com/bypara/bedolaga-cabinet/commit/b6b608eda6065defa00b79d59b9940e7dc49b4b1))
* **ui:** скелетоны вместо спиннеров на пользовательских страницах ([1fc5e72](https://github.com/bypara/bedolaga-cabinet/commit/1fc5e72c3446471a9d34252479dae87e260b1263))
* **ui:** тёмный DateField на react-day-picker вместо нативного input ([edd2d25](https://github.com/bypara/bedolaga-cabinet/commit/edd2d25024989a0b2d7888b82fa2f13dce60b63e))
* **users:** кнопка «Отправить сообщение» в карточке пользователя ([2f743d8](https://github.com/bypara/bedolaga-cabinet/commit/2f743d82dbb4d737fcb5f54dda5269271bae3de2))
* **users:** кнопка удаления подписки в карточке пользователя ([eafc563](https://github.com/bypara/bedolaga-cabinet/commit/eafc563128b68f49f0a1f03a30c899b527ce4734))
* **ws:** уведомления о событиях СБП-автопродления ([e8409a9](https://github.com/bypara/bedolaga-cabinet/commit/e8409a9007e25c685ceaa4b6a88c54237b02303a))


### Bug Fixes

* add back button to gift page ([c2674e4](https://github.com/bypara/bedolaga-cabinet/commit/c2674e4b9bf68c5afa3542022375da7b911b3708))
* address review feedback on admin pages and backgrounds ([9e6372a](https://github.com/bypara/bedolaga-cabinet/commit/9e6372afba53cfd51db50aac0e501df83b61e8bb))
* **admin-remnawave:** причесать иконки в карточках статистики ([7efe069](https://github.com/bypara/bedolaga-cabinet/commit/7efe069be077a35e3538908d24bd68d11407d513))
* **admin-wheel:** unify prize-order banner buttons + drop hardcoded i18n fallbacks ([e4b3c86](https://github.com/bypara/bedolaga-cabinet/commit/e4b3c8640bdbcf18430c736b8027abb51ce612cc))
* **admin-wheel:** unify statistics rendering + fill config UI gaps ([5de43c1](https://github.com/bypara/bedolaga-cabinet/commit/5de43c1071aa1fabb63ce70989afde1e5f431059))
* **admin:** «назад» возвращает туда, откуда экран открыли ([8d688b4](https://github.com/bypara/bedolaga-cabinet/commit/8d688b42bf0c9611a521b7c0a81fa8b26539b546))
* **admin:** «оставить как есть» распознавать без учёта регистра ([4d99cfc](https://github.com/bypara/bedolaga-cabinet/commit/4d99cfca33c362b253e53618c50baf82f01dc128))
* **admin:** close three traps in the cabinet level editor ([7c67969](https://github.com/bypara/bedolaga-cabinet/commit/7c6796917733490d621b5b00ecbc793724a2876c))
* **admin:** gate overpay certificate block by settings permission ([ecc2d45](https://github.com/bypara/bedolaga-cabinet/commit/ecc2d45562b4e9ee43bf4b9b82976245ce872c8f))
* **admin:** harden legal pages editor state handling ([515c3d7](https://github.com/bypara/bedolaga-cabinet/commit/515c3d73b8e60295653fbd5f0390d8e212e0a092))
* **admin:** put the reward-level editor in the admin main menu ([c3eb6c5](https://github.com/bypara/bedolaga-cabinet/commit/c3eb6c5831646cef9aff49b59fc5706b30c7542f))
* **admin:** rework email template editor ([#667043](https://github.com/bypara/bedolaga-cabinet/issues/667043)) ([ac75a80](https://github.com/bypara/bedolaga-cabinet/commit/ac75a806d93374313d8b65d77d6250c87c07a096))
* **admin:** выбор аварийного сквада и очистка числовых полей ([73c5715](https://github.com/bypara/bedolaga-cabinet/commit/73c57153925ef864b0dfe5d659c98078923ff08a))
* **admin:** гейт кнопки повтора, видимый исход доставки и дебаунс поиска ([c39107d](https://github.com/bypara/bedolaga-cabinet/commit/c39107def07f427c52b0acb2b9480223c9764c55))
* **admin:** дополнить тип sort_by и китайскую строку сортировки ([2d6f8d9](https://github.com/bypara/bedolaga-cabinet/commit/2d6f8d97546f7ca69540924aa0637f720500bef3))
* **admin:** дубликат ключа admin.paymentMethods.description ([46c1bc7](https://github.com/bypara/bedolaga-cabinet/commit/46c1bc79a454c71b469a64f82f90a9585f265ab0))
* **admin:** закрыть находки ревью раздела grace-доступа ([9793e8b](https://github.com/bypara/bedolaga-cabinet/commit/9793e8bbe6e01f4504bbe034c18fa07c3d11a05a))
* **admin:** карточка очереди писем видна всегда, а не только когда есть что показать ([2a95c06](https://github.com/bypara/bedolaga-cabinet/commit/2a95c06e319a0653b4d0d97ffc7f4d179420182b))
* **admin:** карточка очереди писем на телефоне — числа плитками, кнопки своим рядом ([1a3c887](https://github.com/bypara/bedolaga-cabinet/commit/1a3c887de35b9604f4cab3e8bd6ea26532dac044))
* **admin:** кастомные цвета темы не сохранялись при дефолтной палитре ([b0570ee](https://github.com/bypara/bedolaga-cabinet/commit/b0570ee0aa596a8ea96d0d8ec94542c68c8722d4))
* **admin:** неверный путь API у страницы системных ошибок ([6b08bee](https://github.com/bypara/bedolaga-cabinet/commit/6b08bee8397292beea0fbadd44a82be4faa6118e))
* **admin:** разбирать 422 от бэкенда и сторожить переводы раздела ([f466b78](https://github.com/bypara/bedolaga-cabinet/commit/f466b78e38e6c7efff4ddb0bfdfec58f9aaedc7f))
* **admin:** сделать имя пользователя в тикете ссылкой на его профиль ([48ef463](https://github.com/bypara/bedolaga-cabinet/commit/48ef4639b21f8221dd7bfc02ac6bff9a65ddb79b))
* **admin:** сделать имя пользователя в тикете ссылкой на его профиль ([5489db6](https://github.com/bypara/bedolaga-cabinet/commit/5489db6b36e7a75fc95475dd408ee56f61011206))
* **admin:** счётчики очереди писем названы честно — они не про всю почту ([0a8b63e](https://github.com/bypara/bedolaga-cabinet/commit/0a8b63e09b38db64cabd4980fb041987aa0bc166))
* **admin:** текст карточки очереди писем не обрезается на телефоне ([93e7182](https://github.com/bypara/bedolaga-cabinet/commit/93e71823b141e2569d61645e5d5e3400a62c5f9e))
* **admin:** фиксированный телеграм-синий у свотча «Синий» вместо акцента темы ([62aaa5d](https://github.com/bypara/bedolaga-cabinet/commit/62aaa5d7c9eaedb5a118469587a35585f9e4f549))
* align SubscriptionRequestRecord type with Remnawave 2.8.0 ([fd5500c](https://github.com/bypara/bedolaga-cabinet/commit/fd5500c85badb95fce620267dff4574b7290258a))
* **auth:** make login footer legal links open real pages, not the login tab ([37a53e4](https://github.com/bypara/bedolaga-cabinet/commit/37a53e40ea37cdba0882f98455d8b00bc9dde2d2))
* **auth:** preload branding before login first paint ([5971965](https://github.com/bypara/bedolaga-cabinet/commit/59719656eada12f2f97057827b4a88e46443ea48))
* **auth:** send Bearer token for account merge endpoints ([6721e25](https://github.com/bypara/bedolaga-cabinet/commit/6721e25df677caf4a13af349364eed5f1b70d85a))
* **auth:** вернуть виджет после «Назад» и добить локали до четырёх ([c108832](https://github.com/bypara/bedolaga-cabinet/commit/c1088325aabaf43de6f60653ff650c3cfb1beb2f))
* **auth:** различать устаревшего бота и ненастроенного на экране логина ([b3b07c3](https://github.com/bypara/bedolaga-cabinet/commit/b3b07c322de5ce48db83661a020dfe96be5b2237))
* **auth:** читать initData из моста Telegram, а не только из кэша SDK ([f81af40](https://github.com/bypara/bedolaga-cabinet/commit/f81af401f7f6ca1a28806cbf237a33da7449d893))
* **auth:** экран согласия на всех Telegram-входах вместо падения «Something went wrong» ([a24058c](https://github.com/bypara/bedolaga-cabinet/commit/a24058c9855199e725b8f0316041b2036ee97d77))
* **backgrounds:** configurable wave colors and boxes grid color with explicit multicolor mode ([725bf8d](https://github.com/bypara/bedolaga-cabinet/commit/725bf8df39bf71ab54a36289f40f9c2791334279))
* **backgrounds:** expose remaining hardcoded colors in shooting-stars, meteors, gradient-animation ([f1f4281](https://github.com/bypara/bedolaga-cabinet/commit/f1f4281e119ca853fd12448541ac15bdb7f72f36))
* **backgrounds:** keep constellation particles in bounds on resize ([acd0d7c](https://github.com/bypara/bedolaga-cabinet/commit/acd0d7c69e8252418e403c1dc97f6647c6c3756d))
* **backgrounds:** legacy config compatibility and locale sync ([caf499a](https://github.com/bypara/bedolaga-cabinet/commit/caf499a824774fa0cfbb84c76a158872db58f224))
* **backgrounds:** live speed and size updates for fireflies ([3df2ef0](https://github.com/bypara/bedolaga-cabinet/commit/3df2ef0f39391ed182d1b71b7dbd273970b62632))
* **backgrounds:** make beams and beams-collision colors configurable ([acbccc8](https://github.com/bypara/bedolaga-cabinet/commit/acbccc8af802ec239381700df80ad83dea58f3a7))
* **backgrounds:** read aurora gradient colors and speed from settings ([66c08b5](https://github.com/bypara/bedolaga-cabinet/commit/66c08b5d6d1431c93473eebd923ac71729f48d65))
* **balance:** align quick amounts edge cases with bot behavior ([9219885](https://github.com/bypara/bedolaga-cabinet/commit/92198854b2efbc213d7bb4a951f85f249d9c9bb2))
* **blocking:** локализовать дефолтное сообщение на экране подписки на канал ([5e2e321](https://github.com/bypara/bedolaga-cabinet/commit/5e2e3214c9e997896860f952aec774aecbbf49a4))
* **branding:** бренд инсталляции во вкладке, фавиконе и ярлыках вместо «VPN»/«V» ([1ca7e48](https://github.com/bypara/bedolaga-cabinet/commit/1ca7e489af577dda7c58302ecba161a3403f056d))
* **branding:** иконки ярлыков без прозрачных углов — iOS и Android заливали их белым ([38a6738](https://github.com/bypara/bedolaga-cabinet/commit/38a6738c4ae98f9ebc61a068aa60fca99e4c47e3))
* **brand:** Safari снова видит логотип во вкладке — подсказка первого кадра только PNG ([fccc16b](https://github.com/bypara/bedolaga-cabinet/commit/fccc16b7d9436203b57a862285b84536d4f4f9c7))
* **brand:** вкладка и ярлыки берут бренд с API ещё до загрузки приложения ([7efd51f](https://github.com/bypara/bedolaga-cabinet/commit/7efd51f6d4f4508fbc68509ff62588d886cd301b))
* **brand:** загрузка логотипа лечит отравленный кеш браузера ([06b331f](https://github.com/bypara/bedolaga-cabinet/commit/06b331fceb85da28563a3f5024cc46a5bdc231ca))
* **brand:** подсказка первого кадра для Safari — плитка с меньшим скруглением ([5869af4](https://github.com/bypara/bedolaga-cabinet/commit/5869af43387a56f63fa2cf3a89dbb9b210c02e3c))
* **brand:** фавикон ведёт на эндпоинт бота — Safari его видит, CORS логотипа цел ([fb4ea70](https://github.com/bypara/bedolaga-cabinet/commit/fb4ea701a5c582107b7bade1139c209ca3d62147))
* **build:** вернуть build:docker, потерянный при мерже dev ([8af8232](https://github.com/bypara/bedolaga-cabinet/commit/8af8232e2f4adfb3a4b4a31855219442e531601e))
* **build:** вернуть тело полифила Object.hasOwn ([f23b3c0](https://github.com/bypara/bedolaga-cabinet/commit/f23b3c0b3454470741745a066bd158879b44209b))
* **cabinet:** blocking screens exit via the native Telegram back button, drop the in-page Close ([f9cc70c](https://github.com/bypara/bedolaga-cabinet/commit/f9cc70cba32debc8edb300869ba652b93f774212))
* **cabinet:** equal-height StatCards so dashboard balance/referral align ([1a3236f](https://github.com/bypara/bedolaga-cabinet/commit/1a3236f6506ffba87d65308a99b4cc0653b0d0ad))
* **cabinet:** harden global encoders against lone UTF-16 surrogates ([d37872f](https://github.com/bypara/bedolaga-cabinet/commit/d37872fd4fa80d781377fc2b2169b3af22b77394))
* **cabinet:** Lava top-up return route + Telegram-unavailable card overflow ([d7f7bc7](https://github.com/bypara/bedolaga-cabinet/commit/d7f7bc7c173817812193aa00b5b2215d2c87159b))
* **cabinet:** recover "Сервис недоступен" false-positive + top-up fixes ([16fad9f](https://github.com/bypara/bedolaga-cabinet/commit/16fad9f4feae4323c181f8a3c1bb33e13071f82b))
* **cabinet:** stop long user data overflowing flex rows on mobile ([63863a0](https://github.com/bypara/bedolaga-cabinet/commit/63863a048bf71793f08a560b26bb41cc3a24bdba))
* **cabinet:** sweep mobile flex-overflow across all pages + components ([800daf7](https://github.com/bypara/bedolaga-cabinet/commit/800daf7506c1c1d1718971d672a8fabb38dfa8e8))
* **ci:** рабочий Trivy-пин, lowercase-референс образа, CodeQL v4 ([0a8b1a4](https://github.com/bypara/bedolaga-cabinet/commit/0a8b1a46d134c88f0222987dd40707d85368ff5a))
* **connected-accounts:** guide the user to enter the existing account's password when merging by email ([7d31dc3](https://github.com/bypara/bedolaga-cabinet/commit/7d31dc3ffa094683c17b81dbf0ee8a555a34da09))
* **connected-accounts:** keep status/unlink inside the card on long IDs ([c39c164](https://github.com/bypara/bedolaga-cabinet/commit/c39c164d51fac8616b994f87ba8bc027a4bf0726))
* **connected-accounts:** stack status + unlink so the full ID shows on mobile ([7383505](https://github.com/bypara/bedolaga-cabinet/commit/7383505a127efc11b166d307eb2f06e1a70972e0))
* **connection:** Happ TV connect renders through the active block style (all 4) ([c91c9e0](https://github.com/bypara/bedolaga-cabinet/commit/c91c9e0441232109398798d4c42711b1c897b5ed))
* **connection:** Happ TV connect works on Apple TV too (one API for both) ([ce7a3ea](https://github.com/bypara/bedolaga-cabinet/commit/ce7a3eaedf4127129de2b2aec3dea85bd9fe48b1))
* **connection:** Happ TV quick-connect is Happ-only + matches config-block styles ([5855a88](https://github.com/bypara/bedolaga-cabinet/commit/5855a88dc630924ea3e047ccb9cc85e578532b08))
* **connection:** keep selected app when switching platform ([f8ac489](https://github.com/bypara/bedolaga-cabinet/commit/f8ac4895fa7def88d2e2905a8df57726f85aa048))
* **connection:** keep the Happ add-subscription button working on Remnawave 2.8.0 ([8f31311](https://github.com/bypara/bedolaga-cabinet/commit/8f31311112979beebeccf2952adcb8f2d4580fdd))
* **connection:** restrict Happ TV quick-connect to Android TV only ([ca54cb4](https://github.com/bypara/bedolaga-cabinet/commit/ca54cb4732ee30cc18a851cd8a6b8b2301194014))
* **connection:** stop ERR_UNKNOWN_URL_SCHEME when opening app deep links on mobile ([325e221](https://github.com/bypara/bedolaga-cabinet/commit/325e221e3209b430a7f5fd95df325802dae5db97))
* **connection:** открывать deep-link приложения на iOS через top-level переход, а не iframe ([03aa2e6](https://github.com/bypara/bedolaga-cabinet/commit/03aa2e6312ae602f087d30d7134020acb6338537))
* **dashboard:** «Продлить» открывает выбор периода вместо молчаливого месяца ([5ce535a](https://github.com/bypara/bedolaga-cabinet/commit/5ce535aead7d7aa295767eeef93a3d69d46fa72c))
* **dashboard:** приветствие без пустого имени для email-пользователей ([147b1fb](https://github.com/bypara/bedolaga-cabinet/commit/147b1fbb2e78bb8b3e0bd690568ea47c429c08c9))
* **dashboard:** счётчик устройств в плитке на главной ([39b9b8e](https://github.com/bypara/bedolaga-cabinet/commit/39b9b8e1d2690c894ce08b0ce16d4780ecffee09))
* **dashboard:** убрать дубль кнопки покупки при пустом списке подписок ([cecfe7e](https://github.com/bypara/bedolaga-cabinet/commit/cecfe7ec038a26eb580404957e70859e0df27e26))
* **datepicker:** убрать скачки и поправить адаптив ([c880517](https://github.com/bypara/bedolaga-cabinet/commit/c8805171693ec4070b9f9bc9b194b4ee91d971fa))
* **datepicker:** читаемость календаря в любой теме ([a8213ce](https://github.com/bypara/bedolaga-cabinet/commit/a8213ce5d5fccd24ee192196a52accbf65954984))
* **deeplink:** поддержать схему incy:// в редиректе добавления подписки ([488503b](https://github.com/bypara/bedolaga-cabinet/commit/488503b360806def859e7792919b68ab29ae44e1))
* **desktop-header:** full-width row so all nav items fit (no overflow/overlap) ([864aeaf](https://github.com/bypara/bedolaga-cabinet/commit/864aeaf600eb3af20f700af2c68f6570abbf1115))
* **desktop-header:** stop layout jumping via 3-column grid ([9fc681b](https://github.com/bypara/bedolaga-cabinet/commit/9fc681b56da18c1453bc2e034d306019c454c771))
* **docker:** слушать IPv6 в nginx — healthcheck на localhost уводил контейнер в unhealthy ([a47e9ab](https://github.com/bypara/bedolaga-cabinet/commit/a47e9ab6999a5da4d9574e3a00bb3ed18a461971))
* **docker:** слушать IPv6 в nginx — healthcheck на localhost уводил контейнер в unhealthy ([ce4ce04](https://github.com/bypara/bedolaga-cabinet/commit/ce4ce046ba34b6439befda2899b87b77316c4030))
* **errors:** структурный detail с бэка больше нигде не попадает в текст ошибки ([1a9c922](https://github.com/bypara/bedolaga-cabinet/commit/1a9c922852d90f227dee35150ae471cbe3d256f5))
* **favicon:** скругляем углы кастомного лого как у плитки в хедере ([7104778](https://github.com/bypara/bedolaga-cabinet/commit/71047780c96b72fe6af3bfca86e8e3b30eb2be9c))
* **geocheck:** сквозные клики через портал и safe-зоны в полноэкранном режиме ([debe26a](https://github.com/bypara/bedolaga-cabinet/commit/debe26ae359545fead38bf087b069e9defecec26))
* **geocheck:** скелетон до отрисовки отчёта и сброс зума на новом отчёте ([5c3031f](https://github.com/bypara/bedolaga-cabinet/commit/5c3031f5f52e4a7bbe101441a97f5e47dd1eff3f))
* **geocheck:** убрать полноэкранный режим в Telegram Mini App ([5db1ffc](https://github.com/bypara/bedolaga-cabinet/commit/5db1ffccf6a6659c06a1fbe5b2b703abd0c609bd))
* **geocheck:** убрать скачивание отчёта в Telegram Mini App ([a451a12](https://github.com/bypara/bedolaga-cabinet/commit/a451a129fe0b211369f336f09f8c8e1abd105173))
* **gift:** cabinet GiftResult shows claim link for directed gifts + review fixes ([b9521f1](https://github.com/bypara/bedolaga-cabinet/commit/b9521f1aa73758ad61d0d0be4686676c051dbe17))
* **gift:** ссылка на подарок из кабинета не открывалась в боте ([12b310b](https://github.com/bypara/bedolaga-cabinet/commit/12b310b2999f371ea47b96dc6c3cc02415e10929))
* guard decodeURI(Component) against lone-surrogate crash ([#667225](https://github.com/bypara/bedolaga-cabinet/issues/667225)) ([81581f5](https://github.com/bypara/bedolaga-cabinet/commit/81581f5c9bdf119afb43e1b1d74ebcfa9934b86c))
* handle consent during Telegram login ([5fa6ab5](https://github.com/bypara/bedolaga-cabinet/commit/5fa6ab5e89e31f747ee85882517b1176dae19a5d))
* **header:** аватар берётся и у бота, а не только из initData ([1137b70](https://github.com/bypara/bedolaga-cabinet/commit/1137b70ee2c1cb729a4760e2cd250f2099ce62b3))
* **header:** кэшировать список языков — переключатель не мигает при смене страницы ([a7ff8a6](https://github.com/bypara/bedolaga-cabinet/commit/a7ff8a6b09281df2b971cddf30a95a4f8b774205))
* hide unconfigured legal footer links ([c4bea69](https://github.com/bypara/bedolaga-cabinet/commit/c4bea69dfee9acf99d6b0b896f482f31cc0fd61c))
* **i18n:** добавить недостающие английские переводы resetPassword и expiredDate_trial ([dd50d64](https://github.com/bypara/bedolaga-cabinet/commit/dd50d648d069bb69db54d18d8e3bdf6bec965872))
* **i18n:** не рисовать интерфейс раньше словарей и темы ([881122f](https://github.com/bypara/bedolaga-cabinet/commit/881122f730f22f1d265e4120e51e52159778406c))
* **i18n:** не рисовать интерфейс раньше словарей и темы ([379ab0e](https://github.com/bypara/bedolaga-cabinet/commit/379ab0e9e61f00ea3dfdf44f99bc3f9b3b813d71))
* **i18n:** починка плейсхолдеров и переводов в zh/fa/en локалях кабинета ([fb1f5cf](https://github.com/bypara/bedolaga-cabinet/commit/fb1f5cf3a762f55f18806be97a0db973316ff6ad))
* **i18n:** существующие ключи вместо отсутствующих common.units.* на экране продления ([516399c](https://github.com/bypara/bedolaga-cabinet/commit/516399cef9fa4a100b5dae979a04fafe0d05e634))
* **i18n:** форматировать даты и числа локалью выбранного языка, а не браузера ([81fd96c](https://github.com/bypara/bedolaga-cabinet/commit/81fd96c2a758d8d092289dbaefa105b29f54137d))
* **landing-stats:** guard gift claim-rate against stale cache (avoid NaN%) ([b210a04](https://github.com/bypara/bedolaga-cabinet/commit/b210a04dbb772fe1faf66f02b6ef6db447e9766e))
* **landing:** заголовок «Loading...» и пустая иконка вкладки на лендингах ([5a6e458](https://github.com/bypara/bedolaga-cabinet/commit/5a6e4589c866a168656285deae214f178491cb12))
* **landing:** не оставлять контакт из ссылки в адресной строке ([acbffa4](https://github.com/bypara/bedolaga-cabinet/commit/acbffa4e17e4549a1068f286e3009b38d30ae6be))
* **payment-methods:** admin display_name/description override locale on balance ([112e09b](https://github.com/bypara/bedolaga-cabinet/commit/112e09bc6d1f0776f3f98602151a7730a8ed9245))
* **payments:** open_url_direct payment URL opens externally in Telegram ([#654272](https://github.com/bypara/bedolaga-cabinet/issues/654272)) ([ce5737f](https://github.com/bypara/bedolaga-cabinet/commit/ce5737fcbc44030595c0dc7a3cfda92e19aa2dbf))
* **promocode:** correct activation UX, error mapping and validity dates ([35428cc](https://github.com/bypara/bedolaga-cabinet/commit/35428cc27d45335c11b8999391bd8a388090fe7b))
* **promocodes:** чекбоксы набора по значениям, трафик в списке ([29c9ed1](https://github.com/bypara/bedolaga-cabinet/commit/29c9ed1a40bad95b187fabd81098a795d4c096da))
* **purchase:** суточная цена с промокодом считается одной функцией на карточке и экране активации ([881e557](https://github.com/bypara/bedolaga-cabinet/commit/881e557d4a8165a6037af05d204780b7db2122e4))
* **reachability:** «Сбросить» не сдвигает округа, чип подписки по умолчанию в две строки на телефоне ([0249ba1](https://github.com/bypara/bedolaga-cabinet/commit/0249ba1823e36d90036364b3fdf50bb2cffe4b9b))
* **reachability:** SNI-хост без переменной — дефолт ads.x5.ru в коде, поле помнит последний ввод как в оригинале ([141a4bf](https://github.com/bypara/bedolaga-cabinet/commit/141a4bfb069bd3b554fd319c9249cccae4ec967d))
* **reachability:** вкладка «Подписка» — кнопки словами без символов, одно предупреждение про оценку цены ([393c6a8](https://github.com/bypara/bedolaga-cabinet/commit/393c6a8fd416f324bf973e15646b00b40efd093a))
* **reachability:** вкладки как в оригинале — Хосты · IP / домен · CIDR · Подписка, пробы с пояснениями, ядро Xray номером ([08a8c6a](https://github.com/bypara/bedolaga-cabinet/commit/08a8c6a7b60b37aab44477d757977816bc183c4b))
* **reachability:** для обычных людей — журнал и прогресс обновляются сами, без сырых ответов, кодов и кнопки «Забрать результат» ([16a4e30](https://github.com/bypara/bedolaga-cabinet/commit/16a4e3088ed8a1de06bffd9c4499e2cded1f5c5c))
* **reachability:** журнал и результаты для людей — ответ словами, вердикт первым, телефон без сломанных углов ([a56bbcc](https://github.com/bypara/bedolaga-cabinet/commit/a56bbcc30c14b942c69e64e776fc7876b77c7ccc))
* **reachability:** как в оригинале — SNI-хост с дефолтом и своими именами, поле «Конфиг или подписка», таблица результата по пробам, журнал проверок, матрица точками ([6996767](https://github.com/bypara/bedolaga-cabinet/commit/699676747fc1c105eef887373185c344e3a8b59f))
* **reachability:** контраст мелкого текста и перенос строки хоста на узких экранах ([a9b6a0a](https://github.com/bypara/bedolaga-cabinet/commit/a9b6a0a3fd4af0d8753e984036516785fa48dc19))
* **reachability:** матрица без сводки «N из M в норме», последний ответ API на экране зависшей пробы ([d704418](https://github.com/bypara/bedolaga-cabinet/commit/d7044185c4bb0b4b104df17103cc72a5447cc919))
* **reachability:** нижние плашки прилипали к концу страницы — &lt;main&gt; с contain: content был containing block для fixed; шиты с отступами, объём по умолчанию от живых счётчиков ([e205dfa](https://github.com/bypara/bedolaga-cabinet/commit/e205dfa8466e86d1e46c7d74bcddf78168e9af3e))
* **reachability:** первый экран с ответом словами, форма без нагромождений, симки сами по хостам ([81e793e](https://github.com/bypara/bedolaga-cabinet/commit/81e793eb2f797103d19864b627310f340dda2db8))
* **reachability:** повтор адреса и порта в списке серверов помечается «тот же сервер» (балансировщик «АВТО») ([198ed32](https://github.com/bypara/bedolaga-cabinet/commit/198ed32b0cb8b89520261b70360c00cd62bc4c19))
* **reachability:** подсказка про длительность пробы по всему флоту — 10–20 минут, результат придёт сам ([15d6969](https://github.com/bypara/bedolaga-cabinet/commit/15d6969079e10e29e4cc6051323359533f978279))
* **reachability:** правки по ручной проверке BSCHEKER ([1371afc](https://github.com/bypara/bedolaga-cabinet/commit/1371afce066d8bba83220c2bb070e6ea836d47ba))
* **reachability:** результат VLESS-теста и матрица на мобильном — таблицей как пробы, нажатая проба с галочкой, иконка «Связи» ([adf7ea6](https://github.com/bypara/bedolaga-cabinet/commit/adf7ea6df601721b4a59d110319d9e7b7644b888))
* **reachability:** счётчик симок и «Сбросить» — в строке заголовка «Операторы» ([b4b6698](https://github.com/bypara/bedolaga-cabinet/commit/b4b66989e4e4dcff8a8c6f24b93ed672bf7f0ef4))
* **reachability:** хвосты — плашка только при целях, округа по порядку и кириллицей, скан и настройка словами ([e7a344a](https://github.com/bypara/bedolaga-cabinet/commit/e7a344ac9362aae8a30204e4adf5b454a2b5312d))
* **referral:** close what the UX review found in the cabinet ([8fdf978](https://github.com/bypara/bedolaga-cabinet/commit/8fdf978b8ad8282f108c67113d58ea45feecea4e))
* **referral:** make the level editor's numeric fields honest ([3a5fc7a](https://github.com/bypara/bedolaga-cabinet/commit/3a5fc7ad465374005fe539ab970d8a8a9538166d))
* **referral:** выключенный вывод средств больше не занимает место на странице ([2f9a92b](https://github.com/bypara/bedolaga-cabinet/commit/2f9a92b0fe39c534e95c32a08f0a5455d4b697d6))
* **referral:** показывать секцию вывода средств всем реферерам ([ce13792](https://github.com/bypara/bedolaga-cabinet/commit/ce13792f96547331f6a5093b7ff5b5ed32d840d9))
* refine mobile legal onboarding ([1b50f10](https://github.com/bypara/bedolaga-cabinet/commit/1b50f102612ee3aceea4507fe2bb4a8d96171f44))
* refresh Telegram token after consent ([1cfe720](https://github.com/bypara/bedolaga-cabinet/commit/1cfe720cda53238ad312e412a3178e4c9f54e7ee))
* **repo:** убрать закоммиченный симлинк node_modules ([906e6bd](https://github.com/bypara/bedolaga-cabinet/commit/906e6bdfdda519d559c633ff893eef2036769561))
* reuse Telegram session after consent ([f4fc0d9](https://github.com/bypara/bedolaga-cabinet/commit/f4fc0d9eb7ae140a216a27d7a251ec07013aa6e7))
* **sales-stats:** «Выручка» → «Оборот по подпискам» во вкладке Продажи ([40c684c](https://github.com/bypara/bedolaga-cabinet/commit/40c684cc8887df8ec6e2287939141a975e4aacbc))
* **sales-stats:** адаптив сетки Допов и сводки ([56d8e1f](https://github.com/bypara/bedolaga-cabinet/commit/56d8e1ffa760558c0196cf1069a5696fe03dd0c9))
* **sales-stats:** крупные суммы сводки без копеек (короче, не режет) ([a687cc3](https://github.com/bypara/bedolaga-cabinet/commit/a687cc3d1878eb22e12129e20b4e60158d62bfd2))
* **sales-stats:** ровные иконки в карточках + не дублировать иконку ([622ec31](https://github.com/bypara/bedolaga-cabinet/commit/622ec318da6eac1cef92c95f244159825345a5e1))
* **sales-stats:** убрать пустые ячейки в сетках карточек ([54998c8](https://github.com/bypara/bedolaga-cabinet/commit/54998c819566b749c282a5f20ab383469f2615ba))
* **sbp-recurring:** toast ошибки отмены + per-sub ключ inline-confirm в админке ([42a7190](https://github.com/bypara/bedolaga-cabinet/commit/42a71902418d3f5e8cd34c225442db40a9a1cf0d))
* **sbp-recurring:** компактный layout СБП-блока на десктопе ([faf4c45](https://github.com/bypara/bedolaga-cabinet/commit/faf4c450b0e995e68fdce6f236a0a1a2de5e85c7))
* **sbp-recurring:** отступ между тогглом автопродления и СБП-блоком ([17e27d3](https://github.com/bypara/bedolaga-cabinet/commit/17e27d343786e9b7e9e013d7c7e1d9e96de6e058))
* **security:** SRI для CDN-скрипта сканера QR ([b615927](https://github.com/bypara/bedolaga-cabinet/commit/b615927283d9ae530c03f6120b3c5794d92e0689))
* **security:** use signed media tokens for ticket attachments ([c6fc167](https://github.com/bypara/bedolaga-cabinet/commit/c6fc167d80898832504000c24860be8c4099fb93))
* **security:** validate the deep-link url in miniapp/redirect.html (open redirect + DOM-XSS) ([b4f0669](https://github.com/bypara/bedolaga-cabinet/commit/b4f066942a613027d8a9c347332ef1efdd29e03d))
* **security:** внутренний гард openAppScheme от опасных схем (CodeQL) ([aa6bf44](https://github.com/bypara/bedolaga-cabinet/commit/aa6bf44db9808aa79e0d711c0331e75171be75c0))
* **security:** инлайновые regex-барьеры для CodeQL в openAppScheme и redirect.html ([51d0f04](https://github.com/bypara/bedolaga-cabinet/commit/51d0f0431a121ad179eb5b376fbab539018040dd))
* **settings:** вернуть в админку категории, которых не было в дереве ([653d683](https://github.com/bypara/bedolaga-cabinet/commit/653d683835e2c10f7690f1f71df3552c3ba9ab2f))
* show mobile back buttons in Telegram ([e8b3c8b](https://github.com/bypara/bedolaga-cabinet/commit/e8b3c8b3d4c05c4166e25dd4af2bc51146bf64f2))
* simplify insufficient gift balance state ([7584e23](https://github.com/bypara/bedolaga-cabinet/commit/7584e23dd42729d16df230b18d23b57a07f9cc2b))
* **storage:** не принимать запись в память за сохранность там, где нужен reload ([803cb2e](https://github.com/bypara/bedolaga-cabinet/commit/803cb2e367cfaa8d1b5aa1d625ba4cc6b33f2ae9))
* **storage:** не ронять приложение, когда браузер запретил хранилище ([673a772](https://github.com/bypara/bedolaga-cabinet/commit/673a772c5b4b0855d9ec176a16e78b4019c202f1))
* **storage:** не считать хранилище мёртвым из-за одного отказа записи ([58e1288](https://github.com/bypara/bedolaga-cabinet/commit/58e12880beb83fce0d89ea46749f8e963b844938))
* **storage:** перевести оставшиеся незащищённые обращения и поставить храповик ([31a3a3e](https://github.com/bypara/bedolaga-cabinet/commit/31a3a3e07c48b277ef8bed6fb0685132ba512cc3))
* **subscription:** fall back to purchase flow for free-tariff switches ([9f909b0](https://github.com/bypara/bedolaga-cabinet/commit/9f909b0f2c22bf9c37ba4e0a74cf7dbaf36e5a02))
* **subscription:** fall back to purchase flow for free-tariff switches ([255777e](https://github.com/bypara/bedolaga-cabinet/commit/255777e7d1db7af09963d397a187bf0d15cc5b39))
* **subscription:** hide legacy notice for disabled access ([f70c1b5](https://github.com/bypara/bedolaga-cabinet/commit/f70c1b59d47f08e43c502467dcf0972703f4dc37))
* **subscriptions:** «+ Купить ещё» только при платной подписке, явный CTA покупки ([39bfef5](https://github.com/bypara/bedolaga-cabinet/commit/39bfef58d0db9ebbe2bd27d4e7f327f02932b81b))
* **subscription:** корректная цена за месяц при выборе периода ([888a02f](https://github.com/bypara/bedolaga-cabinet/commit/888a02f39722c68e4beddefbd1e39c402dfa51cb))
* **subscription:** причины по устройствам из локали, срок действия на своей строке на телефоне ([a1058d7](https://github.com/bypara/bedolaga-cabinet/commit/a1058d73d612e531dc053ba36662fe9ae98912e6))
* **support:** не склеивать t.me со ссылкой на внешний хелпдеск ([f04675b](https://github.com/bypara/bedolaga-cabinet/commit/f04675b2498abbbfb41ba48e0dd8cf7ee3a5a0a1))
* **support:** показывать пользователю отказ бэка при создании тикета ([d889289](https://github.com/bypara/bedolaga-cabinet/commit/d88928912acaaf9eeee52235ee4e2aace5e245e7))
* **support:** ужесточить resolveSupportContact — схема, legacy-username, null ([ebde1f6](https://github.com/bypara/bedolaga-cabinet/commit/ebde1f6174552ab4bef7f1fef8ef7950942781e7))
* **switch-tariff:** route trial & expired subs to the purchase flow ([#629889](https://github.com/bypara/bedolaga-cabinet/issues/629889)) ([5b123f5](https://github.com/bypara/bedolaga-cabinet/commit/5b123f5da034f22ed8d59700cf60d79213d4ea8c))
* **tariffs:** отправлять пустые промогруппы и описание при редактировании тарифа ([f1413de](https://github.com/bypara/bedolaga-cabinet/commit/f1413de5984859e20a58e3212270ccd1495a6954))
* **theme:** readable text on any operator palette + admin consistency pass ([7f68e2c](https://github.com/bypara/bedolaga-cabinet/commit/7f68e2cd5ef510faf54537e8b93c4450be854589))
* **theme:** synchronize mobile color switching ([ce94814](https://github.com/bypara/bedolaga-cabinet/commit/ce948145439c20f34f5b84f059f142308bcac8c5))
* **theme:** операторский фон светлой темы перекрывался заглушкой index.html ([2f4f52a](https://github.com/bypara/bedolaga-cabinet/commit/2f4f52a9a302264b67160d0990ac57081236d1ac))
* **theme:** палитра оператора применяется до первой отрисовки ([d62c8d3](https://github.com/bypara/bedolaga-cabinet/commit/d62c8d39e6e99c91f567a1a4ac13e099ef630cff))
* **theme:** палитра статусных цветов теперь строится от выбранного цвета ([414802b](https://github.com/bypara/bedolaga-cabinet/commit/414802bcff8e1712bf0b718b604a057870d12b58))
* **theme:** стеклянные карточки берут цвет текста из палитры оператора ([fcef18a](https://github.com/bypara/bedolaga-cabinet/commit/fcef18a11e95004c8ae98956d41d41f72bd4713b))
* **tickets:** длинный текст в сообщении уезжал за пределы карточки ([eede5ff](https://github.com/bypara/bedolaga-cabinet/commit/eede5ffdfdde9ece9956817c646ade36a9b2ccf6))
* **tickets:** длинный текст в сообщении уезжал за пределы карточки ([2ba6fc0](https://github.com/bypara/bedolaga-cabinet/commit/2ba6fc0f6f743b8648c0d1e708cd123a465ee77f))
* **traffic:** correct misleading add-traffic note — 30-day validity ([f7bd36a](https://github.com/bypara/bedolaga-cabinet/commit/f7bd36a95e27d9d9257fbfb45f23513b05a6b017))
* **ui:** finish design-audit follow-ups ([9456c7f](https://github.com/bypara/bedolaga-cabinet/commit/9456c7f54eab9ab054472dd54cb527ec42a82571))
* **ui:** keep tariff highlight label visible ([a84082d](https://github.com/bypara/bedolaga-cabinet/commit/a84082d4f70c96a24af12a4a632a19a130f0fd6e))
* **ui:** refine highlighted tariff cards ([b65ad46](https://github.com/bypara/bedolaga-cabinet/commit/b65ad46c7d6f0ebf0c397536de7c819baa81e904))
* **ui:** use consistent referral chevrons ([e2d239f](https://github.com/bypara/bedolaga-cabinet/commit/e2d239f90b4f9a40b3fa3300d22e8681f208cb22))
* **ui:** боковые вырезы в альбомной ориентации iPhone ([2d71d63](https://github.com/bypara/bedolaga-cabinet/commit/2d71d63b68370b9cb3c679a52410eaa80edd7078))
* **ui:** вторичный текст читается на всех темах — токены вместо прозрачности ([c507c24](https://github.com/bypara/bedolaga-cabinet/commit/c507c244a8a762195dc6e8840b809914ca9780b8))
* **ui:** закрыть хвосты консолидации скелетонов ([56a5b25](https://github.com/bypara/bedolaga-cabinet/commit/56a5b25d611fd604a34d3c73415a08545363274b))
* **ui:** контент, пришедший из API после mount, оставался невидимым (stagger) ([adaaa23](https://github.com/bypara/bedolaga-cabinet/commit/adaaa23da390ccdbc8938488fa9d36a00dc9c1db))
* **ui:** мобильная шапка не срезается статус-баром в standalone-режиме iOS ([59c42b1](https://github.com/bypara/bedolaga-cabinet/commit/59c42b197c9003d570c976811609b42cec44d791))
* **ui:** не перезапускать анимированный фон при смене страницы ([1ea9b99](https://github.com/bypara/bedolaga-cabinet/commit/1ea9b99ab579f709db440b103cd37f93b92927ca))
* **ui:** нижний шит в Mini App — не залезает под шапку Telegram, отступ под полоску Home, кнопка «Закрыть» ([bc0ab8b](https://github.com/bypara/bedolaga-cabinet/commit/bc0ab8b9e61924b40fc6a8d980303bf0fc165a3b))
* **ui:** нижняя панель остаётся на карточке подписки ([fee203b](https://github.com/bypara/bedolaga-cabinet/commit/fee203bcfef79897745b3c4ee7472763f57f6233))
* **ui:** нижняя панель только на экранах своих кнопок, плашки не всплывают над клавиатурой ([7bcfd1a](https://github.com/bypara/bedolaga-cabinet/commit/7bcfd1a7f465805ee46125bf1250b03a086e3b4e))
* **ui:** нормализовать detail из ответов API перед рендером — краш на 422 ([9b97293](https://github.com/bypara/bedolaga-cabinet/commit/9b972931cf8ea85f84538bf0b421df2730c4db66))
* **ui:** полоса под статус-баром iOS вместо растянутого стекла шапки ([28fd968](https://github.com/bypara/bedolaga-cabinet/commit/28fd9680f1a2b45068b612e44c6f5ce049e66f2e))
* **ui:** прижатые к низу элементы не прячутся за мобильной панелью ([b7d1391](https://github.com/bypara/bedolaga-cabinet/commit/b7d1391518819689d807d4b5589e9d96aa551e51))
* **ui:** сдвиг страницы, мигание переключателя языка и перезапуск фона при SPA-навигации ([478a693](https://github.com/bypara/bedolaga-cabinet/commit/478a6930198503ab93d9a2d2c5db0d6cbc5a84ef))
* **ui:** фиксированная ширина 100vw — страницы не сдвигаются при появлении скроллбара ([b40f939](https://github.com/bypara/bedolaga-cabinet/commit/b40f939e914453d3080bde6051a7dbcf66a42321))
* **ui:** читаемость держится и на операторских палитрах, а не только на дефолтных ([fe77867](https://github.com/bypara/bedolaga-cabinet/commit/fe7786727b63838b31066d1a911d99e1b87d6096))
* **ui:** ярлык iOS — шапка сливается со статус-баром, панель ближе к краю ([accd1e9](https://github.com/bypara/bedolaga-cabinet/commit/accd1e99c2866ddc5ede338e7434980394596d74))
* **users:** показывать причину отказа при удалении подписки ([415a76f](https://github.com/bypara/bedolaga-cabinet/commit/415a76f7cff4e0e06edb15b91a24467f0465e2e9))
* **wheel:** stop showing fake wins in the browser ([73ee42a](https://github.com/bypara/bedolaga-cabinet/commit/73ee42a0ef38ec36ff6f763304b9521e44d9302a))


### Reverts

* **sales-stats:** убрать карточки возвратов из сводки ([ec23618](https://github.com/bypara/bedolaga-cabinet/commit/ec23618a56f0e1da3b140d2983edf10768000e30))
