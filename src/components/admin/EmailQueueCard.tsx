...
export function EmailQueueCard() {
  ...
  const emailConfigured = data.email_configured ?? data.smtp_configured;
        ...
        <div className="mt-3 flex items-start gap-2 rounded-lg bg-amber-500/10 p-2.5">
          ...
          <p className="text-xs text-amber-200">
            {t(
              ...
              'Способ отправки почты не настроен, письма не отправляются. Проверьте настройки SMTP или Resend.',
            )}
          </p>
        </div>
      )}
