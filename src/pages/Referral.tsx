...
export default function Referral() {
  ...
  // Hide the withdrawal block when the feature is disabled, while keeping old
  // requests visible so users do not lose track of money already in progress.
    ...
    <div className="space-y-5">
      ...
      {withdrawalSectionVisible && (
        <div id="withdrawal-section" className="space-y-5">
          ...
          {/* Withdrawal History */}
          {(withdrawalEnabled || hasWithdrawalHistory) && withdrawalHistory?.items && (
            <details className="bento-card group">
              <summary className="flex cursor-pointer list-none items-center justify-between text-base font-semibold text-dark-100">
