...
## [1.77.0](https://github.com/bypara/bedolaga-cabinet/compare/v1.76.1...v1.77.0) (2026-09-18)


### Features

* **accounts:** предупреждение, какой email будет забыт при отвязке провайдера ([394c59c](https://github.com/bypara/bedolaga-cabinet/commit/394c59cefe000ea0000b4d3c35186969645e8573))
...
* **admin:** «Активность» — каждое нажатие в кабинете ([4118115](https://github.com/bypara/bedolaga-cabinet/commit/41181155cb73494f7232479c60af81ebff547571))
* **admin:** «Активность» — каждый экран и каждое действие, по-человечески ([8c076d8](https://github.com/bypara/bedolaga-cabinet/commit/8c076d89c5a0f075886bf63938803c214547148f))
...
* **admin:** в сводке пользователей карточка «Удалено» — «Всего» складывается из активных, заблокированных и удалённых ([867d88f](https://github.com/bypara/bedolaga-cabinet/commit/867d88f251fb73c326adf1ba39f3150e72559b73))
...
* **admin:** тег панели Remnawave и дни триала в форме тарифа ([46be70e](https://github.com/bypara/bedolaga-cabinet/commit/46be70ed009c990296f7cbac8ebdce2b43c3493d))
...
* **broadcasts:** add legacy sender selection and migration link preview ([b28d7b9](https://github.com/bypara/bedolaga-cabinet/commit/b28d7b9227a4e617e03c709f1801eec37440b391))
...
* **grace:** внешний сквад для «Заменить на указанный» выбирается из списка панели ([6e42870](https://github.com/bypara/bedolaga-cabinet/commit/6e42870f9535cfc290fb27b6a2c0b4a64060ab5f))
* **grace:** поле «что остаётся доступным» и выключатели уведомлений ([d9be0bd](https://github.com/bypara/bedolaga-cabinet/commit/d9be0bd804e2eaad19adf7a156b1912f8423cab9))
...
* **reachability:** вердикты GEO, коды регионов карты, состояние «откуда» и тело запроса ([41c3c00](https://github.com/bypara/bedolaga-cabinet/commit/41c3c00e2baa488a84430790fabd90b048872fe4))
* **reachability:** вкладка GEO — режим, типы и справочник в API кабинета ([ef13faa](https://github.com/bypara/bedolaga-cabinet/commit/ef13faad45f36f15db2689e26360c14df3670bfd))
* **reachability:** вкладка GEO по образцу оригинала — карта РФ с границами, цели переключателем ([d8bae0a](https://github.com/bypara/bedolaga-cabinet/commit/d8bae0a1e372a345f936e4082aa9dc9239d59685))
...
* **reachability:** запуск GEO из вкладки — цели, откуда, метод, резерв и потолок городов в панели ([c2c6bf1](https://github.com/bypara/bedolaga-cabinet/commit/c2c6bf114a6d4760d1b676fe143def810f33f6e9))
...
* **reachability:** карта GEO на телефоне — зум и сдвиг ([59c1b9b](https://github.com/bypara/bedolaga-cabinet/commit/59c1b9bc3ce2f23c58e1043e201ce3108de9d798))
* **reachability:** карта регионов РФ для GEO — регион красится по худшему результату его городов ([a3d66cf](https://github.com/bypara/bedolaga-cabinet/commit/a3d66cf12e6e9b150f0f614c5483426aa5349a5f))
...
* **reachability:** повтор города GEO — в тот же тест, без новой строки в истории ([ead124a](https://github.com/bypara/bedolaga-cabinet/commit/ead124a311cf58001f7c2402ccbf3a80343c5f9e))
* **reachability:** повтор города GEO один в один с оригиналом и подсказка панелью на телефоне ([fb365d5](https://github.com/bypara/bedolaga-cabinet/commit/fb365d56a2263e67debe195ac5e3ecf0fe690d49))
* **reachability:** подписка на тысячи серверов и причины отказа словами ([c661b60](https://github.com/bypara/bedolaga-cabinet/commit/c661b6040e46f189917405337076f5deae9ece47))
* **reachability:** подсказка карты GEO как в оригинале и перепроверка города из отчёта ([0d1be2c](https://github.com/bypara/bedolaga-cabinet/commit/0d1be2cdb506a8e1bdb02941fc5acf232950062c))
...
* **reachability:** результат GEO — сводка вердиктов, карта, города с фильтрами, история ([7ad64fd](https://github.com/bypara/bedolaga-cabinet/commit/7ad64fd48471316a041848faf2de76c45b5b0889))
...
* **reachability:** форма GEO — цели из трёх источников, «откуда» по справочнику, метод пробы ([d691209](https://github.com/bypara/bedolaga-cabinet/commit/d691209fb050f9bfd0429ba0bfa80d26b4dbaa8a))
...
* **reachability:** ярлык «Проверить из городов РФ» с карточки хоста ([2795aa7](https://github.com/bypara/bedolaga-cabinet/commit/2795aa76a30a9aa540bd35e75e95978dc8b5eeaa))
...
* **subscription:** выгодный период выбирается сразу, а не первый по счёту ([14832d0](https://github.com/bypara/bedolaga-cabinet/commit/14832d0d219506e629c25005520c297801bdf585))
...
* **users:** второй проход раздела «Пользователи» по референсу — меньше надписей, всё доделано ([6625ccd](https://github.com/bypara/bedolaga-cabinet/commit/6625ccd83b6cf024e9a38cc801785a9ae1cdaed4))
* **users:** замечания владельца — иконка раздела, фильтры одной кнопкой, онлайн по панели, плитки с иконками, без дублей ([ab4852b](https://github.com/bypara/bedolaga-cabinet/commit/ab4852bb6785607f0ce690886f62da38bfa6aa83))
* **users:** карточка — шапка с фактами, пять вкладок из адреса, опасные действия за подтверждением ([8b58efd](https://github.com/bypara/bedolaga-cabinet/commit/8b58efd857e175487bd3de9f031e93f30bfdf500))
...
* **users:** одно поле поиска, сегменты и чипы фильтров, адрес и лента вместо страниц ([9edaea6](https://github.com/bypara/bedolaga-cabinet/commit/9edaea6f75b912488fb9f4a56957b30bcdc28da8))
* **users:** состояние списка в адресе, разбор одного поля поиска и относительное время ([cac1374](https://github.com/bypara/bedolaga-cabinet/commit/cac1374c5fec7890878f76cea9c3ed6e890c3e54))
* **users:** шапка без «Продлить», плитки по режиму продаж — классика, тариф, мультитариф ([7190728](https://github.com/bypara/bedolaga-cabinet/commit/71907284b5a6e85648efae41ff4ae15d7bc934a7))
...
* «Действует до: Invalid Date» в карточке успеха — нераспознанную дату показывать как есть ([603fdd0](https://github.com/bypara/bedolaga-cabinet/commit/603fdd098af197b8392ee7b8eca57e35b7356046))
...
* **admin:** админка на телефоне — ничего не уезжает за экран, таблицы листаются, суммы не рвутся ([b5b4a0d](https://github.com/bypara/bedolaga-cabinet/commit/b5b4a0d73cb5af54ca0246f0676ce4181d0be322))
...
* **admin:** карточка пользователя пересоздаётся при переходе к другому пользователю ([16f83b2](https://github.com/bypara/bedolaga-cabinet/commit/16f83b2ddfa7f82c339fe26d35a7636a74ff8edc))
...
* **admin:** не слать ноль выгодного периода при создании тарифа ([8b36331](https://github.com/bypara/bedolaga-cabinet/commit/8b363311db8673ddd174ae80473fd61731a65584))
...
* **admin:** цену периода тарифа можно поставить нулём ([e53803a](https://github.com/bypara/bedolaga-cabinet/commit/e53803a153ad551008a18481e365ad827b0698d4))
...
* **auth:** keep email verification flow visible ([e7cd9ab](https://github.com/bypara/bedolaga-cabinet/commit/e7cd9abffab6ce294c070e3a68bb3f692ca4c367))
...
* **grace:** кнопка «Скрыть» у блока «Дополнительно» не работала при настроенном внешнем скваде ([ddd3504](https://github.com/bypara/bedolaga-cabinet/commit/ddd350421da35260812cadbb867f4e6a2808712f))
* **grace:** подзаголовок раздела без прибитого Telegram ([29af2c5](https://github.com/bypara/bedolaga-cabinet/commit/29af2c536dcfdc0b5787908c1b7a1b2243e17b10))
* **grace:** подсказка поля «что остаётся доступным» — фраза в сообщениях теперь после двоеточия ([6553146](https://github.com/bypara/bedolaga-cabinet/commit/655314660db44063e3f3fc1a397dfa882d96c983))
* **grace:** раздел grace-доступа по канону дизайна и человеческими словами ([974c7c8](https://github.com/bypara/bedolaga-cabinet/commit/974c7c829d70616b4b96dd921fc8fb0bf07e7ad4))
* **grace:** состояние в две карточки, режимы и сквады описаны словами ([09f4485](https://github.com/bypara/bedolaga-cabinet/commit/09f44858ed76a77572c53cbd7596acac7eb8e71c))
...
* isolate React vendor chunk from dependent UI libraries ([9fd0909](https://github.com/bypara/bedolaga-cabinet/commit/9fd09091d8ea82bcf8fec4f3f04d4f49e963d5ee))
...
* **reachability:** без прокрутки к списку при касании карты GEO на телефоне ([a6aa3fe](https://github.com/bypara/bedolaga-cabinet/commit/a6aa3fe6f8da418cc36aa0cb9ea6485a6911071c))
...
* **reachability:** карта GEO на телефоне — касание сужает список, а не дублирует его панелью ([903f67a](https://github.com/bypara/bedolaga-cabinet/commit/903f67aec56414c7152a1aaa9ddf973c2d4397cd))
* **reachability:** карта без глифов подписей — они перехватывали клики по регионам ([5e39ccd](https://github.com/bypara/bedolaga-cabinet/commit/5e39ccdad6b05904ddde480b1d68afcf90c2d390))
* **reachability:** кнопки повтора GEO в каноне кабинета — логика оригинала, вид свой ([ea87ee2](https://github.com/bypara/bedolaga-cabinet/commit/ea87ee2543a2352f80c3b0c7f0c73c73d3da95ac))
...
* **reachability:** слои карты без подчёркиваний — в произвольных вариантах Tailwind они становились пробелами ([a0dd1c9](https://github.com/bypara/bedolaga-cabinet/commit/a0dd1c98e62f272e9790ff248e3ce0ce564d3160))
...
* **security:** pin patched Tiptap 3.30.5 and verify editor safety ([ebc096d](https://github.com/bypara/bedolaga-cabinet/commit/ebc096d86fe65ad606a0696726babf57875c07db))
...
* **subscription:** выбранный выгодный вариант не теряет жёлтый контур ([388b974](https://github.com/bypara/bedolaga-cabinet/commit/388b974fbd148fda82bf489d65303987bafcb8e9))
...
* **subscription:** не спрашивать состояние выключенной автооплаты ([57a3d94](https://github.com/bypara/bedolaga-cabinet/commit/57a3d94d0b4c61d2042557c037d267e67a9e6e47))
...
* **ui:** вёрстка на телефоне — ничего не режется и не слипается, «Выгодно» одним видом на всех витринах ([468e227](https://github.com/bypara/bedolaga-cabinet/commit/468e227086573c327ee750bc09c911db81b2ddc0))
...
* **ui:** карточка подписки не уезжает за край на телефоне ([db7344c](https://github.com/bypara/bedolaga-cabinet/commit/db7344c0ccfbc80af29446017f9b07309ed96abb))
...
* **users:** без дублей выборки и BSCHEKER, два направления сверки с панелью, рефералы в окне у кнопки ([e04b786](https://github.com/bypara/bedolaga-cabinet/commit/e04b78609be32e8c8007122913360f7dd810f6c3))
* **users:** все действия карточки — кнопками, без многоточий в подписях ([d8b2c70](https://github.com/bypara/bedolaga-cabinet/commit/d8b2c7049f24b825e21f36d1b020ec503cfb05b6))
* **users:** плитки «Рефералов» и «Баланса» — к общему виду карточки ([95634ce](https://github.com/bypara/bedolaga-cabinet/commit/95634ce7ecb65a2d8f2a9fd72b41a1555f3aeee6))
...
* в строке списка видно временный доступ и сколько у человека тарифов ([29c54f4](https://github.com/bypara/bedolaga-cabinet/commit/29c54f431b169a934fc1d58b49f1c8fd5db1400f))
* дни на графике дохода — календарные, а не полночь UTC (bot [#3136](https://github.com/bypara/bedolaga-cabinet/issues/3136)) ([06c9802](https://github.com/bypara/bedolaga-cabinet/commit/06c9802829c0fdc58556408843e9f87fd60c40a1))
* зелёная точка «в сети» гаснет сама, без ответа сервера ([051a8d8](https://github.com/bypara/bedolaga-cabinet/commit/051a8d8a2a63201e515e035d579b87d962465850))
* карточка сверки объясняет временный доступ вместо «Есть отличия» ([3e443f6](https://github.com/bypara/bedolaga-cabinet/commit/3e443f6cfc48045ddab956ef4a1629495c8a949b))
* отказ сброса триала объясняется словами, а не английской строкой ([82bf3ac](https://github.com/bypara/bedolaga-cabinet/commit/82bf3ac074d64ef921f008986346f8279704afd3))
* телефон — пометка временного доступа, клавиша ввода в поиске, кнопка «Наверх» ([82326b0](https://github.com/bypara/bedolaga-cabinet/commit/82326b09e04aa9badf70171bc528077cb8ce77c7))
